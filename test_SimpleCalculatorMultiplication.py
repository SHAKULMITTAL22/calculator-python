...
class Test_SimpleCalculatorMultiplication:
    ...
    def test_multiplication_large_numbers(self):
        num1 = 10**10  # TODO: adjust values as needed for tests
        num2 = 10**8   # TODO: adjust values as needed for tests
        result = SimpleCalculator.multiplication(num1, num2)
        assert result == 10**18
    ...
    def test_multiplication_mixed_magnitudes(self):
        num1 = 1e10  # TODO: adjust values as needed
        num2 = 1e-10 # TODO: adjust values as needed
        result = SimpleCalculator.multiplication(num1, num2)
        assert result == 1.0
    ...
    def test_multiplication_limits_of_precision(self):
        ...
        num2 = 0.6666666667
        result = SimpleCalculator.multiplication(num1, num2)
        assert pytest.approx(result, rel=1e-9) == 0.2222222222
