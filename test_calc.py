...
# ********RoostGPT********
def test_subtraction_with_large_negative_numbers(self):
        result = SimpleCalculator.subtraction(-1000000, -500000)
        assert result == -500000

def test_subtraction_with_mixed_signed_numbers(self):
        result1 = SimpleCalculator.subtraction(5, -3)
        result2 = SimpleCalculator.subtraction(-5, 3)
        assert result1 == 8
        assert result2 == -8

def test_subtraction_with_small_decimal_points(self):
        result = SimpleCalculator.subtraction(0.001, 0.0005)
        assert result == 0.0005

def test_subtraction_with_very_small_numbers(self):
        result = SimpleCalculator.subtraction(1e-10, 1e-11)
        assert result == 9e-11
...
def test_large_and_small_integer_multiplication(self):
    result = SimpleCalculator.multiplication(10**10, 0.000001)
    assert result == 10**10 * 0.000001

def test_zero_floating_point_multiplication(self):
    result = SimpleCalculator.multiplication(0.0, 5.5)
    assert result == 0.0

def test_negative_zero_multiplication(self):
    result = SimpleCalculator.multiplication(-0.0, 4.5)
    assert result == -0.0
