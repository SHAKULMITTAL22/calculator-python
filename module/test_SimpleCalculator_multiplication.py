...
# Scenarios:
#   - [happy_path] positive_numbers: Verify that multiplying two positive integers returns the correct product.
#   - [happy_path] negative_numbers: Verify that multiplying two negative integers returns a positive product.
...
#   - [edge_case] multiply_by_one: Verify that multiplying any number by one returns the original number.
