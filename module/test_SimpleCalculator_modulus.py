...
#   run_id:        abeed5a2
#   generated_at:  2026-04-27T07:37:48Z
#   scenarios:
...
#     - [happy_path ] negative_dividend: Verify modulus with a negative dividend, ensuring it follows Python's modulo behavior.
#     - [happy_path ] negative_divisor: Verify modulus with a negative divisor, ensuring it follows Python's modulo behavior.
#     - [edge_case  ] zero_dividend: Verify modulus when the dividend is zero.
#     - [happy_path ] floating_point: Verify modulus with floating point numbers.
#
# Regenerate with:
#   roost-pytest unit \
...
def test_negative_dividend():
    """Verify modulus with a negative dividend, ensuring it follows Python's modulo behavior."""
    result = SimpleCalculator.modulus(-10, 3)
    assert result == 2
...
def test_negative_divisor():
    """Verify modulus with a negative divisor, ensuring it follows Python's modulo behavior."""
    result = SimpleCalculator.modulus(10, -3)
    assert result == -2
...
def test_floating_point():
    ...
    result = SimpleCalculator.modulus(10.5, 3)
    assert result == 1.5
