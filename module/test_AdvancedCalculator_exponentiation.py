...
#   run_id:        9d75d6db
#   generated_at:  2026-04-27T08:32:55Z
#   scenarios:
#     - [happy_path ] positive_integers: Verify exponentiation with positive integer base and exponent.
#     - [happy_path ] zero_exponent: Verify that any non-zero base raised to the power of 0 is 1.
...
#     - [error_path ] zero_base_negative_exponent: Verify that raising 0 to a negative power raises ZeroDivisionError.
...
def test_zero_base_negative_exponent():
    """Verify that raising 0 to a negative power raises ZeroDivisionError."""
